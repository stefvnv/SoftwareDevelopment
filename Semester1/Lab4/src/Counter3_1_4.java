...
public class Counter3_1_4 {
	 ...
	 */
	public static void reader(File f) throws FileNotFoundException {
		int words = 0;
		int vowels = 0;
		...
		// 2_2. Count the number of vowels in the file and the average number of vowels per word
	...
	public static String[] jumble(String[] words) {
		for (int i = 0; i < words.length; i++) {
			int random = (int) ((Math.random() * (words.length - 2)) + 1);
